...
from utils.instancenormalization import InstanceNormalization
from keras.layers import Input, Dense, Reshape, Flatten, Dropout, Concatenate
from keras.layers import BatchNormalization, Activation, ZeroPadding2D, Add
from keras.layers.advanced_activations import LeakyReLU, ELU
from keras.layers.convolutional import UpSampling2D, Conv2D, Conv2DTranspose
from keras.layers.merge import add
from utils.ReflectionPadding2D import ReflectionPadding2D
# import utils.ReflectionPadding2D
...
class CycleGAN():
    ...
    def sample_images(self, data_loader, batch_i, run_folder, test_A_file, test_B_file):
        ...
        for p in range(2):
            ...
            for i in range(r):
                for j in range(c):
                    axs[i,j].imshow(self.bgr2rgb(gen_imgs[cnt]))
